...
public class ExpressionEvaluationHelperTest {
    ...
    public void convertToSpelExpression_ShouldHandleCompoundExpressions() {
        ...
        assertEquals("#age >= 18 && #weight <= 100",
                expressionHelper.convertToSpelExpression(complexCondition));
    ...
    public void convertToSpelExpression_ShouldHandleArrayVariations() {
        ...
        assertTrue(expressionHelper.convertToSpelExpression(emptyArray)
                .contains("#allergies.containsAll(new java.util.ArrayList(T(java.util.Arrays).asList()))"));

        // Single item
        String singleItem = "allergies == ['AL1']";
        assertTrue(expressionHelper.convertToSpelExpression(singleItem)
                .contains("#allergies.containsAll(new java.util.ArrayList(T(java.util.Arrays).asList('AL1')))"));

        // Mixed quotes
        String mixedQuotes = "allergies == ['AL1',\"AL2\"]";
        assertTrue(expressionHelper.convertToSpelExpression(mixedQuotes)
                .contains("#allergies.containsAll(new java.util.ArrayList(T(java.util.Arrays).asList('AL1',\"AL2\")))"
                ));

        // With spaces
        String withSpaces = "allergies == ['AL 1', 'AL 2']";
        assertTrue(expressionHelper.convertToSpelExpression(withSpaces)
                .contains("#allergies.containsAll(new java.util.ArrayList(T(java.util.Arrays).asList('AL 1', 'AL 2'))" +
                        ")"));
    }
    ...
    public void convertToSpelExpression_ShouldHandleReservedWords() {
        ...
        assertEquals("#greater == 10 && #equals >= 5",
                expressionHelper.convertToSpelExpression(withReservedWords));
    }
    ...
    public void convertToSpelExpression_ShouldHandleMultipleArrayComparisonPatterns() {
        ...
        assertTrue(result.contains("#allergies.containsAll(new java.util.ArrayList(T(java.util.Arrays).asList('AL1'))" +
                ")"));
